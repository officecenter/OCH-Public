...
.PARAMETER Path
    The path.
.EXAMPLE 
Moves a known folder to OneDrive for Business folder and sets new KnownFolderPath:

$folder = "Documents"
Move-Item -Path $env:USERPROFILE\$folder -Destination $env:OneDrive -Force
Set-KnownFolderPath -KnownFolder $folder "$env:OneDrive\$folder"
#>
